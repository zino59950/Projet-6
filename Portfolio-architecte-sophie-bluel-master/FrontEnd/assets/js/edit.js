    ...
    works.forEach(function (work) {
        ...
        workElement.innerHTML = `
            <div style="display: flex; justify-content: flex-end;">
                ...
                <div class="delete-icon" style="margin-left: -15px;z-index:999" onclick="deleteProject(${work.id})">
...
// Lorsque l'utilisateur se connecte ou lorsque vous obtenez le token d'une autre manière
const userToken = "le_token_d_utilisateur"; // Remplacez cela par la valeur réelle du token
...
async function deleteProject(itemId) {
    ...
    console.log('Token d\'utilisateur:', userToken);
    if (!userToken) {
...
async function getWorksFromAPI() {
    try {
        ...
        if (!response.ok) {
            throw new Error('Erreur lors de la récupération des œuvres depuis l\'API.');
        }
